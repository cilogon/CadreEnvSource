...
class CadreEnvSource extends AppModel {
  ...
  public function availableAttributes() {
    ...
    $attributes = array(
      'env_identifier_sorid' => array(
        ...
        'required' => true,
        'desc'     => _txt('pl.cadreenvsource.sorid.desc'),
        'canLogin' => false
      ),
      'env_name_honorific' => array(
      ...
      'env_affiliation_scoped' => array(
        'label'   => _txt('pl.cadreenvsource.affiliation_scoped.desc'),
        'default' => 'ENV_OIS_AFFILIATION_SCOPED'
      ),
      'env_title' => array(
        'label'   => _txt('fd.title'),
